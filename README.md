...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/FB_OLD_ID_CLONER/blob/main/20250805_155233.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/FB_OLD_ID_CLONER
    $ cd  FB_OLD_ID_CLONER
    $ python Mithila.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/FB_OLD_ID_CLONER && cd FB_OLD_ID_CLONER && python Mithila.py
 ### Hi there 👋
